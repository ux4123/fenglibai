...
//	p[len] = '\0';
	...
	for (i = len + 1; i > len-mode; i--)
	{
		p[i]=p[i-1];
	}
	p[i] = '.';
	//for()
	OLED_ShowStr(x,y,temp,1);
}

void Show_Init(void)
{
	static flag_before,Mode_before;
	
	if(Display_Flag!=flag_before||Key_Mode!=Mode_before)
	{
		OLED_CLS();
		flag_before = Display_Flag;
		Mode_before = Key_Mode;
	}
	switch(Key_Mode)
	{
		case 0: OLED_ShowStr(0,0,"Start Mode",2);break;
		case 1: Key_Mode=1;OLED_ShowStr(0,0,"Debug Mode",2);break;
		case 2: Key_Mode=2;OLED_ShowStr(0,0,"Control Mode",2);break;
		case 3: Key_Mode=3;OLED_ShowStr(0,0,"Display Mode",2);break;
	}
	switch(Display_Flag)
	{
		case 1:
			OLED_ShowStr(0,2,"roll:",1);
			OLED_ShowStr(0,3,"pitch:",1);
			OLED_ShowStr(0,4,"yaw:",1);
			OLED_ShowStr(60,2,"Kp=",1);
			OLED_ShowStr(60,3,"Kd=",1);
			OLED_ShowStr(60,4,"Ki=",1);break;
		case 2:
			switch(Debug_Value)
				{
					case 0:OLED_ShowStr(0,2,"Kp=",1);
								 OLED_ShowStr(0,3,"Kd=",1);
								 OLED_ShowStr(0,4,"Ki=",1);break;
//					case 3:OLED_ShowStr(0,15,"Kd_Y=");break;
//					case 4:OLED_ShowStr(0,15,"Kp_Pos_X=");break;
//					case 5:OLED_ShowString(0,15,"Kd_Pos_X=");break;
//					case 6:OLED_ShowString(0,15,"Kp_Pos_Y=");break;
//					case 7:OLED_ShowString(0,15,"Kd_Pos_Y=");break;
//					case 8:OLED_ShowString(0,15,"Ki_Pos_X=");break;
